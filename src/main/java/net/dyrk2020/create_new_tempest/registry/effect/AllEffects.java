package net.dyrk2020.create_new_tempest.registry.effect;

import net.dyrk2020.create_new_tempest.effect.AugmentedFrameEffect;
import net.dyrk2020.create_new_tempest.effect.OverclockEffect;
