package net.dyrk2020.create_new_tempest.registry.race;

import com.github.manasmods.tensura.registry.race.TensuraRaces;
import net.dyrk2020.create_new_tempest.race.mechanical_scholar.MechanicalExpertRace;
import net.dyrk2020.create_new_tempest.race.mechanical_scholar.MechanicalNoviceRace;
import net.dyrk2020.create_new_tempest.race.mechanical_scholar.MechanicalScholarRace;
import net.dyrk2020.create_new_tempest.race.mechanical_titan.MechanicalColossusRace;
import net.dyrk2020.create_new_tempest.race.MechanicalConstructRace;
import net.dyrk2020.create_new_tempest.CreateNewTempest;
import net.dyrk2020.create_new_tempest.race.mechanical_titan.MechanicalGiantRace;
import net.dyrk2020.create_new_tempest.race.mechanical_titan.MechanicalTitanRace;
import net.dyrk2020.create_new_tempest.race.mechanical_warrior.MechanicalCombatantRace;
import net.dyrk2020.create_new_tempest.race.mechanical_warrior.MechanicalSoldierRace;
import net.dyrk2020.create_new_tempest.race.mechanical_warrior.MechanicalWarriorRace;
