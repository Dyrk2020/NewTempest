package net.prebuildtempest.create_new_tempest.ability.skill.intrinsic.mechanical_titan;
...
import net.prebuildtempest.create_new_tempest.registry.effect.AllEffects;
...
public class AugmentFrameSkill extends Skill implements Transformation {
    ...
    public boolean canIgnoreCoolDown(ManasSkillInstance instance, LivingEntity entity) {
        return entity.hasEffect(AllEffects.AUGMENTED_FRAME.get());
    }

    public void onToggleOff(ManasSkillInstance instance, LivingEntity entity) {
        entity.removeEffect(AllEffects.AUGMENTED_FRAME.get());
    }

    public void onPressed(ManasSkillInstance instance, LivingEntity entity) {
        if (entity instanceof Player player) {
            if (!this.failedToActivate(player, AllEffects.AUGMENTED_FRAME.get())) {
                if (!player.hasEffect(AllEffects.AUGMENTED_FRAME.get())) {
                    ...
                    player.addEffect(new MobEffectInstance((MobEffect)AllEffects.AUGMENTED_FRAME.get(), this.isMastered(instance, player) ? 7200 : 3600, 0, false, false, false));
                    ...
                    player.removeEffect(AllEffects.AUGMENTED_FRAME.get());
