package net.prebuildtempest.create_new_tempest.registry.effect;

import net.prebuildtempest.create_new_tempest.effect.AugmentedFrameEffect;
import net.prebuildtempest.create_new_tempest.effect.OverclockEffect;
