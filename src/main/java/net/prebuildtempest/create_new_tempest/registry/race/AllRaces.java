package net.prebuildtempest.create_new_tempest.registry.race;

import com.github.manasmods.tensura.registry.race.TensuraRaces;
import net.prebuildtempest.create_new_tempest.race.mechanical_scholar.MechanicalExpertRace;
import net.prebuildtempest.create_new_tempest.race.mechanical_scholar.MechanicalNoviceRace;
import net.prebuildtempest.create_new_tempest.race.mechanical_scholar.MechanicalScholarRace;
import net.prebuildtempest.create_new_tempest.race.mechanical_titan.MechanicalColossusRace;
import net.prebuildtempest.create_new_tempest.race.MechanicalConstructRace;
import net.prebuildtempest.create_new_tempest.CreateNewTempest;
import net.prebuildtempest.create_new_tempest.race.mechanical_titan.MechanicalGiantRace;
import net.prebuildtempest.create_new_tempest.race.mechanical_titan.MechanicalTitanRace;
import net.prebuildtempest.create_new_tempest.race.mechanical_warrior.MechanicalCombatantRace;
import net.prebuildtempest.create_new_tempest.race.mechanical_warrior.MechanicalSoldierRace;
import net.prebuildtempest.create_new_tempest.race.mechanical_warrior.MechanicalWarriorRace;
