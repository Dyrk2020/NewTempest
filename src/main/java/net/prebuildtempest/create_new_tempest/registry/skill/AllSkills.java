package net.prebuildtempest.create_new_tempest.registry.skill;


import net.prebuildtempest.create_new_tempest.CreateNewTempest;
import net.prebuildtempest.create_new_tempest.ability.skill.intrinsic.mechanical_scholar.MechanicalBodySkill;
import net.prebuildtempest.create_new_tempest.ability.skill.intrinsic.MechanicalEyeSkill;
import com.github.manasmods.manascore.api.skills.ManasSkill;
import com.github.manasmods.manascore.api.skills.SkillAPI;
import net.prebuildtempest.create_new_tempest.ability.skill.intrinsic.MechanicalHandsSkill;
import net.prebuildtempest.create_new_tempest.ability.skill.intrinsic.mechanical_titan.AugmentFrameSkill;
import net.prebuildtempest.create_new_tempest.ability.skill.intrinsic.mechanical_warrior.OverclockSkill;
//import net.prebuildtempest.create_new_tempest.ability.skill.ultimate.DeusExMachinaSkill;
